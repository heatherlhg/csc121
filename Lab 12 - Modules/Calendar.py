...
# The user will choose what year to display.
# ----------------------------------------------------------------
...
def getYear():
    ...
    """ Returns a year between 1800-2099, inclusive, or the value -1 """
    ...
    while (year < 1800 or year > 2099) and year != -1:
        ...
        year = int(input('Enter year (1800-2099), or -1 to quit: '))
...
def constructCalMonth(month_num, first_day, num_days_in_month):
    ...
    """ Returns a formatted calendar month for display on the screen.
        ...
        [month_name, week1, week2, week3, week4, ...]
    """
...
def constructCalYear(year):
    ...
    """ Returns a formatted calendar year for display on the screen.
        ...
        twelve constructed months [year, month1, month2, ..., month12]
    """
